...
import { WarehouseCheckoutPage, ParcelInspectionsPage, WarehouseTrackPage } from '@/pages/warehouse/WarehousePages'
            ...
            <Routes>
              ...
              <Route path="/change-password" element={<ChangePasswordPage />} />
                ...
                <Route element={<RequireRole roles={['WarehouseStaff', 'Administrator']} />}>
                  ...
                  <Route path="/warehouse/checkout"    element={<WarehouseCheckoutPage />} />
                  <Route path="/warehouse/inventory"   element={<WarehouseInventoryPage />} />
                  <Route path="/warehouse/inspections" element={<ParcelInspectionsPage />} />
