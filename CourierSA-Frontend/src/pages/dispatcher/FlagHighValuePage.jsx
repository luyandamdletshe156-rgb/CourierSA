...
export default function FlagHighValuePage() {
  ...
  return (
    <AppShell title="Secure Delivery & OTP Management">
      <div className="max-w-6xl mx-auto space-y-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Secure Delivery & OTP Management</h1>
          <p className="text-sm text-gray-500 mt-1">
            Monitor high-value parcels (≥ R2,000), manage security flagging, and resend OTPs to recipients.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden">
          ...
          {loading ? (
            <p className="p-6 text-sm text-gray-500 text-center">Loading queue...</p>
              ...
              <table className="w-full text-left text-sm text-gray-600">
                <thead className="bg-gray-100 text-xs font-semibold uppercase text-gray-500 border-b">
                  <tr>
                    ...
                    <th className="px-6 py-3">Quote Amount</th>
